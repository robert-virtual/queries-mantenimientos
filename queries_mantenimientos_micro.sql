...
CREATE
DATABASE queries_mantenimientos_db;
USE
queries_mantenimientos_db;
...
(
    ...
    data_json nvarchar(MAX) COLLATE Modern_Spanish_CI_AS NULL,
    [date] datetime2 NULL,
...
(
    ...
    parameters      nvarchar(MAX) COLLATE Modern_Spanish_CI_AS NULL,
    requested_at    datetime2 NULL,
    requested_by    int NOT NULL,
    response        nvarchar(255) COLLATE Modern_Spanish_CI_AS NULL,
    status          nvarchar(50) COLLATE Modern_Spanish_CI_AS NOT NULL,
    where_condition nvarchar(MAX) COLLATE Modern_Spanish_CI_AS NULL,
